...
1. Check producer logs
    ```
    docker logs smart-factory-kafka-spark-flink-kafka-producer-1 -f
    ```
...
1. Check consumer with Spark logs
    ```
    docker logs smart-factory-kafka-spark-flink-kafka-consumer-spark-1 -f
    ```
...
1. Check consumer with Flink logs
    ```
    docker logs smart-factory-kafka-spark-flink-kafka-consumer-flink-1 -f
    ```
